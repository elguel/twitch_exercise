...
def twitch_etl():
    ...
    for file_name in os.listdir(directory_path):
        ...
        dtype_dic_chat = {'body': types.String(), 'channel_id': types.INTEGER(),'commenter_id': types.INTEGER(),'created_at': types.DateTime(), 'offset':types.DECIMAL, 'updated_at':types.DateTime(), 'video_id':types.INTEGER, 'emoticon_id':types.INTEGER, 'text':types.String(), 'polarity':types.FLOAT}
